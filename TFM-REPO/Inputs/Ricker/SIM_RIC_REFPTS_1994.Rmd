---
title: "Ejercicio Stock-Recruitment Reference Points 1994 Ricker CV02"
...
output_dir <- "C:/Users/Tito/Documents/Tito CDS/MTE/TFM IEO/Case Studies/Imagenes/RICsim_1994"

# Combinamos la carpeta con el nombre del archivo
output_file <- file.path(output_dir, paste0(params$n_iter,"_",params$cv,"_",params$model_type," 1994_plot_series.png"))
...
El objeto resultante con la variabilidad de los residuos introducida bajo control es "stk_stf" en este caso 1000 iteraciones con una variabilidad de 0,6 (CV = 0.6) como caso extremo.
...
save(lista_params,file = paste0(params$n_iter,"_",params$cv,"_",params$model_type," Variables_RIC_1994.RData"))
```